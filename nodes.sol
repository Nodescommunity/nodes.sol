...
/** follow us
    website: https://nodescommunity.org/
    twitter: https://twitter.com/nodescommunity
    facebook: https://www.facebook.com/nodescommunity
    instagram: https://www.instagram.com/nodescommunity.id/
    linkedin: https://www.linkedin.com/company/nodes-community/
    */
...
IERC20Metadata {
     ...
     * `amount`.
     */
    function transferFrom(address from, address to, uint256 amount)public virtual override returns(
        bool
    ) {
    ...
    function _transfer(address from, address to, uint256 amount)internal virtual {
        ...
        unchecked {
            ...
            // Overflow not possible: the sum of all balances is capped by totalSupply, and
            // the sum is preserved by decrementing then incrementing.
            _balances[to] += amount;
        }
...
contract NODES is ERC20,
Ownable {
    using Address for address; constructor()ERC20("NODES", "NODES") {
    ...
    /**
     * @dev Check if an address corresponds to a contract.
     * @param account The address to check.
     * @return True if the address corresponds to a contract, false otherwise.
     */
    function isContract(address account)internal view returns(bool) {
        return account.isContract(); // Use the isContract function from Address library
    }
}
